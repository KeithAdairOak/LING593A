...
articles = set(json.load(open(dictionarypath + 'articles.json',encoding="utf8")))
redirects = json.load(open(dictionarypath + 'redirects.json',encoding="utf8"))
aliases = json.load(open(dictionarypath + 'aliases.json',encoding="utf8"))
given_names = json.load(open(dictionarypath + 'given_names.json',encoding="utf8"))
surnames = json.load(open(dictionarypath + 'surnames.json',encoding="utf8"))
other_disambiguations = json.load(open(dictionarypath + 'disambiguations_other.json',encoding="utf8"))
...
number_disambiguations = json.load(open(dictionarypath + 'disambiguations_number.json',encoding="utf8"))
...
with open(dictionarypath + 'given_names_dict.json', 'w',encoding="utf8") as f:
    json.dump(given_names_dict, f,indent=4,ensure_ascii=False)
...
with open(dictionarypath + 'redirects.json', 'w',encoding="utf8") as f:
    json.dump(new_redirects, f,indent=4,ensure_ascii=False)
...
with open(dictionarypath + 'aliases_sorted.json', 'w',encoding="utf8") as f:
    json.dump(new_aliases_sorted, f,indent=4,ensure_ascii=False)
...
with open(dictionarypath + 'mostly_upper.json', 'w',encoding="utf8") as f:
    json.dump(list(mostly_upper), f,indent=4,ensure_ascii=False)

#with open(dictionarypath + 'mostly_lower.json', 'w') as f:
#    json.dump(list(mostly_lower), f,indent=4,ensure_ascii=False)

with open(dictionarypath + 'aliases_reversed_sorted.json','w',encoding="utf8") as f:
    json.dump(new_aliases_reversed_sorted,f,indent=4,ensure_ascii=False)
...
with open(dictionarypath + 'redirects_upper.json', 'w',encoding="utf8") as f:
    json.dump(new_redirects_upper, f,indent=4,ensure_ascii=False)

with open(dictionarypath + 'redirects_reversed.json', 'w',encoding="utf8") as f:
    json.dump(new_redirects_reversed, f,indent=4,ensure_ascii=False)

with open(dictionarypath + 'redirects_reversed_upper.json', 'w',encoding="utf8") as f:
    json.dump(new_redirects_reversed_upper, f,indent=4,ensure_ascii=False)
...
#        if not any(candidate.lower().startswith(ignore + ':') for ignore in IGNORED_NAMESPACES) and not candidate.startswith('List of'):
        if not any(candidate.lower().startswith(ignore + ':') for ignore in IGNORED_NAMESPACES) and not '一覧' in candidate and not 'の登場' in candidate:
...
#        if not any(tuple[0].lower().startswith(ignore + ':') for ignore in IGNORED_NAMESPACES) and not tuple[0].startswith('List of'):
        if not any(tuple[0].lower().startswith(ignore + ':') for ignore in IGNORED_NAMESPACES) and not '一覧' in tuple[0] and not 'の登場' in tuple[0]:
            new_l.append(tuple)
...
with open(dictionarypath + 'aliases_sorted_pruned.json', 'w',encoding="utf8") as f:
    json.dump(new_aliases_sorted_pruned, f,indent=4,ensure_ascii=False)



with open(dictionarypath + 'aliases_reversed_sorted_pruned.json','w',encoding="utf8") as f:
    json.dump(new_aliases_reversed_sorted_pruned,f,indent=4,ensure_ascii=False)
...
with open(dictionarypath + 'aliases_sorted_pruned_upper.json', 'w',encoding="utf8") as f:
    json.dump(new_aliases_sorted_pruned_upper, f,indent=4,ensure_ascii=False)

with open(dictionarypath + 'aliases_reversed_sorted_pruned_upper.json','w',encoding="utf8") as f:
    json.dump(new_aliases_reversed_sorted_pruned_upper,f,indent=4,ensure_ascii=False)
...
with open(dictionarypath + 'most_popular_entities_10000.json','w',encoding="utf8") as f:
    json.dump(most_popular_entities,f,indent=4,ensure_ascii=False)
